...
```bash
pnpm add "github:halfmoon-project/halfmoon-design#tokens-v0.3.0&path:packages/tokens"
```
...
pnpm add "github:halfmoon-project/halfmoon-design#tokens-v0.3.0&path:packages/tokens"
pnpm add "github:halfmoon-project/halfmoon-design#react-v0.1.1&path:packages/react"
```
